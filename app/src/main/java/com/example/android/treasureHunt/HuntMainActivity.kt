...
class HuntMainActivity : AppCompatActivity() {
    ...
    /**
     * Variable to check what API the device is running.
     */
 ...
 */
    ...
    private fun checkDeviceLocationSettingsAndStartGeofence(resolve:Boolean = true) {
        ...
        val locationSettingsResponseTalk =
            settingsClient.checkLocationSettings(builder.build())

        locationSettingsResponseTalk.addOnFailureListener { exception ->
        ...
        locationSettingsResponseTalk.addOnCompleteListener {
            if (it.isSuccessful) {
                addGeofenceForClue()
            }
        }
    ...
    private fun requestForegroundAndBackgroundLocationPermissions() {
        ...
        ActivityCompat.requestPermissions(
            this, permissionsArray, resultCode)
    }
